...
<div class="col-md-offset-1  col-md-8 mt30" >
	...
	<!-- begin for form  -->
	      ...
	      <div class="form-group">
		    ...
		    <label>Query protein sequence</label>
                    <textarea name="pred_area" class="form-control" rows="5"    placeholder="Please paste your sequence here in raw format...    e.g. ATGCGCATCGT"></textarea>
               </div>
