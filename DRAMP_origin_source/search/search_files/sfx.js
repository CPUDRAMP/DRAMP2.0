...
function report_expand(id, newC, i) {
	if(!i)
		i = 0;
...
function report_getpref(id, cookiename)
{
	var obj = document.getElementById(id+"_1");
	var button = document.getElementById(id+"_0");
	var newobjclass;

	var cookieVal = getCookie(cookiename);

	if(cookieVal != null && button)
	{
		if(cookieVal == 0)
		{
			button.className = 'nosel';
			newobjclass = 'hide';
		}
		else if(cookieVal == 1)
		{
		...
		report_expand(id, newobjclass, 1);
	}
}
