                  ...
                  <form role="advanced search" action="advanced_search.php" method="get">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-8">
                              ...
                              <label class="checkbox-inline">
                                <input type="checkbox" name="ckbx1[]" value="tumor" id="CheckboxGroup1_6" /> tumor
                              </label>
                              <label class="checkbox-inline">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-8">
                          <input type="text" name="activity[0]" class="form-control" id="words" placeholder="e.g. E. coli or S. aures"/>
                      </div>
                      <div class="col-md-4">
                        <ul class="list-inline" style="padding-top:8px;">
