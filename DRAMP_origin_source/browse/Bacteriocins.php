...
<div class="container">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Bacteria Data</li>
        </ol>
    </div>
    <div class="row mt40">
...
echo<<<END_END
	<tr><th style="border-right-style: none"><input id="CheckAll" onclick="SelectAll('browse_parent','browse_child')" name="browse_parent" type="checkbox" /></th><th style="width:80px;border-left-style: none">DRAMP ID</th><th>Peptide NAME</th><th>Source</th><th>Biological Activity</th><th>Target Organism</th><th>Swiss-Prot Entry</th></tr>
END_END;
